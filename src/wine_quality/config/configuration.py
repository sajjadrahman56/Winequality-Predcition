...
from wine_quality.entity.config_entity import DataIngestionConfig, DataTransformationConfig,DataValidationConfig, ModelTrainerConfig
...
class ConfigurationManager:
    def __init__(
            ...
            schema_filepath=SCHEMA_FILE_PATH):  # type: ignore
